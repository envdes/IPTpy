...
# bash /work/n02/n02/yuansun/shell_scripts/archive/IPTpy/ceds.sh
# this script is used to run FCnudged with CEDS anthropogenic emissions for testing IPTpy
# squeue -u yuansun
...
export TYPE=ceds
export CASE_NAME="/work/n02/n02/yuansun/cesm/runs/${CASE_LOCATION}/iptpy_${TYPE}"
